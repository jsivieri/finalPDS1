package com.iftm.courseSpringPDS1.config;
...
import com.iftm.courseSpringPDS1.entities.Payment;
...
import com.iftm.courseSpringPDS1.repositories.OrderRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * Category(null , "Books" ); Category cat3 = new Category(null , "Computers" );
		 * 
		 ...
		 * Product( null , "PC Gamer" , "Donec aliquet odio ac rhoncus cursus." ,
		 * 1200.0, ""); Product p5 = new Product( null , "Rails for Dummies" ,
		 * "Cras fringilla convallis sem vel faucibus." , 100.99, "");
		 * 
		 * productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
		 * 
		 * p1.getCategories().add(cat2); p2.getCategories().add(cat1);
		 * p2.getCategories().add(cat3); p3.getCategories().add(cat3);
		 * p4.getCategories().add(cat3); p5.getCategories().add(cat2);
		 * 
		 * productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
		 * 
		 */
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-06-23T13:02:55Z"));
